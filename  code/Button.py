...
class Window(QWidget):
    ...
    def initUI(self):
        ...
        self.b4.setText("Dialogue_Box")
        self.b4.move(800, 400)
        self.b4.clicked.connect(self.on_pushButton_clicked)
        self.b4.layout = QHBoxLayout(self)
        self.b4.layout.addWidget(self.b4)
    ...
    def b1_clicked(self):
        ...
        QgsApplication.setPrefixPath("/usr", True)
        QgsApplication.initQgis()
        self.viewer = MapViewer("shapefiles/my_polygon.shp")
        self.viewer.show()
...
class MyGrid(QTableView):
    def __init__(self, parent=None):
        ...
        if __name__ == '__main__':
            Mx, My, Mrx, Mry, flg1, flg2, error=affine_equation.main()
